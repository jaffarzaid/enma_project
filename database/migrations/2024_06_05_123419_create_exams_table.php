...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('exams', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('non_bahraini_registered_id');
            ...
            $table->foreign('non_bahraini_registered_id')->references('id')->on('non_bahraini_registered_courses')->onDelete('cascade')->onUpdate('cascade');
