    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class=" col-md-8 col-lg-5">
                ...
                @else
                    <form action="{{ route('store.old_trainee.data') }}" method="POST" class="mbr-form form-with-styler"
                        ...
                        <div class="dragArea row input-main">
                            ...
                            <div class="form-check">
                                ...
                                <label for="dec_1" class="form-check-label">
                                    I confirm that the information that I have provided in this application is accurate,
                                    correct
                                    ...
                                    requested or giving false information may make me ineligible for enrollment, admission,
                                    or
                                    compel my expulsion
                            ...
                            <div class="form-check">
                                ...
                                <label for="dec_2" class="form-check-label">
                                    I, also, hereby acknowledge that I have read and understood the Enma Terms and
                                    Conditions
