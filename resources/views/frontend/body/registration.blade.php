    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class=" col-md-8 col-lg-5">
                <div class="col-md-12">
                    <h1 class="mbr-fonts-style mbr-fonts-style mbr-section-title text-primary align-center display-3 p-3">
                        ...
                        <div class="dragArea row input-main">
                            ...
                            <div class="col-md-4 form-group mb-3">
                                <label for="last_name" class="form-control-label mbr-fonts-style display-8">Last Name
                                    <span style="color: red;"> *</span></label>
                                <input type="text" name="last_name" class="form-control display-7" id="last_name" required>
                                @error('last_name')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 form-group mb-3">
                                <label for="nationality" class="form-control-label mbr-fonts-style display-8">Nationality <span
                                        style="color: red;"> *</span></label>
                                <select name="nationality" class="form-control display-7" id="nationality" required
                                    onchange="toggleTamkeen()">
                            ...
                            <div class="col-md-4 form-group mb-3">
                                <label for="cpr" class="form-control-label mbr-fonts-style display-8">CPR <span
                                        style="color: red;"> *</span></label>
                                <input type="number" name="cpr" class="form-control display-7" id="cpr" required>
                                @error('cpr')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 form-group mb-3">
                                <label for="phone_1" class="form-control-label mbr-fonts-style display-8">Phone 1 <span
                                        style="color: red;"> *</span></label>
                                <input type="tel" name="phone_1" class="form-control display-7" id="phone_1" required>
                                @error('phone_1')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            {{-- Phone 2 --}}
                            <div class="col-md-6 form-group mb-3">
                                <label for="phone_2" class="form-control-label mbr-fonts-style display-8">Phone 2 <span
                                        style="color: red;"> *</span></label>
                                <input type="tel" name="phone_2" class="form-control display-7" id="phone_2" required>
                                @error('phone_2')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            {{-- Birthday --}}
                            <div class="col-md-4 form-group mb-3">
                                <label for="birthday_date" class="form-control-label mbr-fonts-style display-8">Birthday <span
                                        style="color: red;"> *</span></label>
                            ...
                            {{-- Home Address --}}
                            <div class="col-md-4 form-group mb-3">
                                <label for="home_address" class="form-control-label mbr-fonts-style display-8">Home Address
                                    <span style="color: red;"> *</span></label>
                            ...
                            {{-- Email --}}
                            <div class="col-md-4 form-group mb-3">
                                <label for="trainee_email" class="form-control-label mbr-fonts-style display-8">Email<span
                                        style="color: red;"> *</span></label>
                                <input type="email" name="trainee_email" class="form-control display-7" id="trainee_email"
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <input type="text" name="emergency_name" class="form-control display-7"
                            ...
                            {{-- Relationship --}}
                            <div class="col-md-4 form-group mb-3">
                                <label for="emr_relationship"
                                    class="form-control-label mbr-fonts-style display-8">Relationship <span
                                        style="color: red;"> *</span></label>
                                <input type="text" name="emr_relationship" class="form-control display-7"
                                    id="emr_relationship" required>
                            ...
                            {{-- Emergency Contact --}}
                            <div class="col-md-4 form-group mb-3">
                                <label for="emr_phone" class="form-control-label mbr-fonts-style display-8">Emergency Phone
                                    <span style="color: red;"> *</span></label>
                                <input type="tel" name="emr_phone" class="form-control display-7" id="emr_phone"
                                    required>
                                @error('emr_phone')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-4 form-group mb-3">
                                <label for="qualification" class="form-control-label mbr-fonts-style display-8">Qualification
                                    <span style="color: red;"> *</span></label>
                                <select name="qualification" class="form-control display-7" id="qualification" required>
                            ...
                            <div class="col-md-4 form-group mb-3">
                                <label for="specialization"
                                    class="form-control-label mbr-fonts-style display-8">Specialization <span
                                        style="color: red;"> *</span></label>
                                <select name="specialization" class="form-control display-7" id="specialization" required>
                            ...
                            <div class="col-md-4 form-group mb-3">
                                <label for="student_gpa" class="form-control-label mbr-fonts-style display-8">GPA <span
                                        style="color: red;"> *</span></label>
                                <input type="number" name="student_gpa" class="form-control display-7" id="student_gpa"
                                    step="0.01" required>
                                @error('student_gpa')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                                ...
                                <div style="display: flex;">
                                    <div data-for="male" class="form-check" style="margin-right: 10px;">
                                        <input type="radio" value="Arabic" name="instruction_lang"
                                            class="form-check-input" id="arabic" required>
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <input type="file" name="edu_certificate" class="form-control display-7"
                                    id="edu_certificate" required>
                            ...
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <input type="file" name="edu_transcripts" class="form-control display-7"
                                    id="edu_transcripts" required>
                            ...
                            {{-- Studying Status --}}
                            <div class="col-md-6 form-group mb-3">
                                <label for="gender-form3-1p" class="form-control-label mbr-fonts-style display-8">Are you
                                    studying now? <span style="color: red;"> *</span></label>
                                <div style="display: flex;">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                <label for="study_status_specification" class="form-control-label mbr-fonts-style ">If Yes,
                                    specify</label>
                                <input type="text" name="study_status_specification" class="form-control"
                                    id="study_status_specification">
                            </div>
                            ...
                            <div class="col-md-3 form-group mb-3">
                                <label for="pro_cer_name" class="form-control-label mbr-fonts-style ">Cetification
                                    Name</label>
                                <input type="text" name="pro_cer_name" class="form-control" id="pro_cer_name"
                                    placeholder="AWS AI & Machine Learning">
                            </div>
                            ...
                            <div class="col-md-3 form-group mb-3">
                                ...
                                <input type="text" name="pro_cer_spec" class="form-control" id="pro_cer_spec"
                                    placeholder="Artificial Intellegence">
                            </div>

                            {{-- Awarding Body --}}
                            <div class="col-md-3 form-group mb-3">
                                <label for="pro_cer_awbd" class="form-control-label mbr-fonts-style display-8">Awarding
                                    Body</label>
                            ...
                            <div class="col-md-3 form-group mb-3">
                                ...
                                <input type="number" name="pro_cer_year" class="form-control" id="pro_cer_year"
                                    placeholder="2020">
                            </div>
                            ...
                            {{-- Experience --}}
                            <div class="col-md-12">
                                <h1 class="mbr-fonts-style mbr-fonts-style mbr-section-title text-primary display-7 p-3">Work
                                    Experience</h1>
                            </div>

                            {{-- Job Title --}}
                            <div class="col-md-3 form-group mb-3">
                                <label for="stu_job_title" class="form-control-label mbr-fonts-style display-8">Job
                                    Title</label>
                                <input type="text" name="stu_job_title" class="form-control" id="stu_job_title"
                                    placeholder="Manager">
                            </div>

                            {{-- Job Nature --}}
                            <div class="col-md-3 form-group mb-3">
                                <label for="stu_job_natu" class="form-control-label mbr-fonts-style display-8">Job
                                    Nature</label>
                                <input type="text" name="stu_job_natu" class="form-control" id="stu_job_natu"
                            ...
                            <div class="col-md-12">
                                <h1 class="mbr-fonts-style mbr-fonts-style mbr-section-title text-primary display-7 p-3">Health
                                    & Safety Information</h1>
                            </div>

                            <div class="col-md-6 form-group mb-3">
                                <label for="stu_injury_status" class="form-control-label mbr-fonts-style display-8">Do you
                                    have any significant injury, disability, and/or medical conditions? <span
                                        style="color: red;">*</span></label>
                                <div style="display: flex;">
                                    <div class="form-check" style="margin-right: 10px;">
                                        <input type="radio" value="Yes" name="stu_injury_status"
                                            class="form-check-input" id="stu_injury_status_yes" onclick="toggleFileUpload()"
                                            required>
                                        <label for="stu_injury_status_yes" class="form-check-label">Yes</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" value="No" name="stu_injury_status"
                                            class="form-check-input" id="stu_injury_status_no" onclick="toggleFileUpload()">
                                        <label for="stu_injury_status_no" class="form-check-label">No</label>
                                    </div>
                                </div>
                                ...
                                <div style="display: flex;">
                                    <div class="form-check" style="margin-right: 10px;">
                                        <input type="radio" value="Yes" name="emergency_exit" class="form-check-input"
                                            id="emergency_exit_yes" onclick="toggleFileUpload()" required>
                                    ...
                                    <div class="form-check">
                                        <input type="radio" value="No" name="emergency_exit" class="form-check-input"
                                            id="emergency_exit_no" onclick="toggleFileUpload()">
