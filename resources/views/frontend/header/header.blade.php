<section data-bs-version="5.1" class="menu menu2 cid-uduhEtpcnc" once="menu" id="menu2-1i">
        ...
        <div class="container-fluid">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('frontend/assets/images/enma-logo-1-384x384.png') }}" alt="Mobirise Website Builder" style="height: 3rem;">
                    </a>
                </span>
                <span class="navbar-caption-wrap"><a class="navbar-caption text-primary display-7" href="{{ route('home') }}">Enma Institute</a></span>
            </div>
