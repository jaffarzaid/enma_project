...
@section('dynamic')
    <span class="count_top"><i class="fa fa-home"></i> <span class="green"> / All Job Seeker Trainees</span></span>
    <br>
                ...
                <table class="table table-bordered table-hover text-center">
                    ...
                    <tbody>
                        @foreach ($job_seeker_trainees as $key => $trainee)
                            <tr>
                                <th scope="row">{{ ($job_seeker_trainees->currentPage() - 1) * $job_seeker_trainees->perPage() + $key + 1 }}</th>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-primary" href="{{ route('edit.trainer', $trainee->id) }}" title="Edit"><i
