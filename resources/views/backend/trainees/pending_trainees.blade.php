                    ...
                    <tbody>
                        @foreach ($pending_trainees as $trainee)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit.trainee.info', $trainee->trainee_id) }}" title="Edit"><i
                                            class="fa fa-edit"></i></a>
                                    <a href="{{ route('view.trainee.details', $trainee->trainee_id) }}" title="Approve"><i
                                            class="fa fa-thumbs-up"></i></a>
                                    <a href="{{ route('read.trainee.details', $trainee->trainee_id) }}" title="View"><i
